# Decide what each finding deserves

Every finding gets exactly one of three answers, and you pick the smallest one that fits. It's the whole point of the pack, so be slow here.
...
That third answer takes the most discipline, and it's what the gate protects. A pass that reports every day trains the person reading it to skip the channel on the day something real lands there.

One bound is worth stating plainly. This pass may propose, and it may not merge. Whatever review stands between a branch and your default branch is what keeps the loop safe, and it stays a person's.
