...
« [previous: H1 Bead-creation formula extensions](./01-bead-creation-formula-extensions.md) | [next: H3 Architecture best-practices loop](./03-architecture-best-practices-loop.md) »
